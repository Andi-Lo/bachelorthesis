...
var dataTTFB = {
    labels: ["06.02.","09.02.","10.02.","12.02.","13.02.","17.02.","18.02.","19.02.","20.02.","23.02.","05.03."],
    datasets: [
        {
            label: "Repeat View",
    ...
    datasets: [
        {
            ...
            pointHighlightFill: "#fff",
            pointHighlightStroke: "rgba(220,220,220,1)",
            data: [1774,925,1312,1190,418,784,908,595,614,592,510]
        },
        {
            label: "First View",
            fillColor: "rgba(62,134,237,0.2)",
            ...
            pointHighlightFill: "#fff",
            pointHighlightStroke: "rgba(151,187,205,1)",
            data: [3486,1915,2961,2456,1483,2567,2458,2621,1106,1237,1233]
        }
    ]
};
    ...
    datasets: [
        {
            ...
            pointHighlightFill: "#fff",
            pointHighlightStroke: "rgba(220,220,220,1)",
            data: [2611,1741,2171,2358,2228,1705,3852,3683,2972,2330,667]
        },
        {
            label: "First View",
            fillColor: "rgba(62,134,237,0.2)",
            ...
            pointHighlightFill: "#fff",
            pointHighlightStroke: "rgba(151,187,205,1)",
            data: [7190,4992,6089,7571,5555,6122,7600,7316,5665,4325,2450]
        }
    ]
};
