...
\label{sec:der_weg_zur_performance}
	...
	%
		...
		\label{ssub:arbeiten_mit_einem_performance_budget}
			...
			Für Designer (als auch Entwickler) ergibt sich ein Rahmen. Dies muss in keiner Weise schlecht sein und Dan Mall, Art Director und Designer sagt dazu folgendes:\footnote{Den vollen Artikel gibt es hier: \url{http://danielmall.com/articles/how-to-make-a-performance-budget/}}
