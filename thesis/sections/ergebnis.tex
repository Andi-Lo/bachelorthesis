...
\label{sec:der_weg_zur_performance}
	...
	% - Die Bereitschaft für Performance im Unternehmen muss geschaffen sein
	% - Es muss klar sein, warum Performance wichtig ist (für jeden)
	% - Es muss dem Client klar gemacht werden, das kann nur geschehen wenn man selber weiß wovon man spricht
	% - Arbeitsprozess mittels Performance Budget
	% - Auch das Design muss kommuniziert werden
