...
\label{sec:workflow}
	...
	\label{sub:node_package_manager}
		...
		\label{ssub:bower}
			...
			\begin{figure}[htbp]
				\begin{center}
					\includegraphics[width=0.2\textwidth]{bower_structure.jpg}
...
gulp.task('javascript', function () {
	...
	\label{sub:yeoman}
		...
		\begin{figure}[htbp]
			\begin{center}
				\includegraphics[width=\textwidth]{php_storm_scaffolding.jpg}
		...
		\begin{figure}[htbp]
			\begin{center}
				\includegraphics[width=0.6\textwidth]{yeoman_generator.jpg}
		...
		\begin{figure}[htbp]
			\begin{center}
				\includegraphics[width=\textwidth]{yeoman_project_start.jpg}
