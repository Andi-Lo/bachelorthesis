...
\label{sec:entwicklung}
	...
	\label{sub:tools}
		...
		\label{ssub:speedcurve}
			...
			\begin{figure}[htbp]
				\begin{center}
					\includegraphics[width=0.75\textwidth]{speedcurve.jpg}
		...
		\begin{figure}[htbp]
			\begin{center}
				\includegraphics[width=0.6\textwidth]{what_does_my_site_cost.jpg}
	...
	\label{sub:ausgangspunkt}
		...
		\label{sub:best_practices}
			...
			\subsubsection{Render Blocking Javascript / CSS} % (fold)
			\label{ssub:render_blocking_javascript}
				...
				Im Vergleich dazu kann mit Hilfe des Javascripts in Listing \ref{lst:deferJs} die Datei "`defer.js"' komplett mit dem Laden verzögert werden, bis der Ladeprozess der Seite abgeschlossen ist.
...
\end{lstlisting}
			...
			% subsubsection render_blocking_javascript_css (end)
		...
		3A2Z4B3E3M 3E3T4A
				...
				\begin{figure}[htbp]
					\begin{center}
						\includegraphics[width=0.65\textwidth]{gzip_compression.jpg}
